                    ...
                    return (
                      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-2.5">
                        <div className="bg-white border border-gray-200 rounded-xl p-2.5 sm:p-3 shadow-3xs">
                          <span className="text-[10px] sm:text-[11px] font-extrabold text-gray-500 block whitespace-nowrap tracking-wide [word-spacing:1.5px]">TỔNG GIÁ TRỊ ĐƠN</span>
                        ...
                        <div className="bg-emerald-50 border border-emerald-300 rounded-xl p-2.5 sm:p-3 shadow-3xs">
                          <span className="text-[10px] sm:text-[11px] font-extrabold text-emerald-800 block whitespace-nowrap tracking-wide [word-spacing:1.5px]">THỰC TẾ ĐÃ THU</span>
                        ...
                        <div className={`rounded-xl p-2.5 sm:p-3 shadow-3xs border ${
                          ...
                          <span className={`text-[10px] sm:text-[11px] font-extrabold block whitespace-nowrap tracking-wide [word-spacing:1.5px] ${
